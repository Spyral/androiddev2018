...
//    private Authentication authentication;
    ...
    private final LinkedHashMap<String, Chat> chat = new LinkedHashMap<String, Chat>();
...
//    }
     ...
     */
    public Chat getConversation(String name)
    {
        return chat.get(name.toLowerCase());
    }
    ...
    {
        chat.put(conversation.getName().toLowerCase(), conversation);
    }
...
//    }
    ...
    public ArrayList<String> getCurrentChannelNames()
    {
        ...
        Collection<Chat> mConversations = chat.values();

        for (Chat conversation : mConversations) {
            if (conversation.getType() == Chat.TYPE_CHANNEL) {
